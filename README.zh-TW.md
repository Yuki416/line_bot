...
> 把二創虛擬角色「LadyRice」做成一個能在 LINE 上聊天、畫圖、回答自身設定問題的聊天機器人。
...
LadyRice 是一位以《賽馬娘》米浴（Rice Shower）為原型的二創角色：深黑色帶藍光短髮、紫色眼睛、藍玫瑰髮飾，個性內向溫柔、熱愛抹茶甜點與街頭穿搭，設定上是遊走於京都與東京之間的虛擬網紅。
